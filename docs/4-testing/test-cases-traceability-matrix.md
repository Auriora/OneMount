...
|--------------------------|-------------|--------------------------------|--------------|
| AD-001 | Use of FUSE for filesystem implementation | SDS 2.1 (Class Diagram - Filesystem class), SDS 6.1 (Dependencies - go-fuse/v2) | UT-FS-01, ST-01, ST-02 |
| AD-002 | On-demand file download instead of full sync | SDS 2.1 (Class Diagram - DownloadManager class), SDS 3.1 (Sequence Diagram - File Access Not Cached) | UT-FS-03, ST-08 |
| AD-003 | Local caching of metadata and content | SDS 2.1 (Class Diagram - LoopbackCache and ThumbnailCache classes), SDS 5.3 (Database Schema), SDS 6.2 (Performance Considerations - Caching) | UT-FS-01, UT-FS-03, IT-01, IT-06 |
| AD-004 | Use of BBolt for embedded database | SDS 2.1 (Class Diagram - Filesystem with db attribute), SDS 5.3 (Database Schema), SDS 6.1 (Dependencies - bbolt) | UT-FS-01, IT-01, IT-06 |
...
| AD-008 | Concurrent operations for uploads and downloads | SDS 2.1 (Class Diagram - UploadManager and DownloadManager with worker goroutines), SDS 6.2 (Performance Considerations - Concurrent Operations) | UT-FS-02, UT-FS-05-01, UT-FS-05-02, UT-FS-06, UT-FS-03 |

## Use Cases

| Use Case ID | Use Case Name | Related Requirements | Test Case IDs |
|-------------|---------------|----------------------|--------------|
| UC-FS-001 | Mount OneDrive Filesystem | FR-FS-001, FR-AUTH-001, FR-AUTH-002, FR-UI-001, FR-UI-002, NFR-SEC-001, NFR-USE-003 | UT-FS-01, SEC-01, SEC-04 |
| UC-FS-002 | Access and Modify Files | FR-FS-002, FR-FS-004, FR-FS-005, NFR-PERF-001, NFR-PERF-003, NFR-PERF-004, NFR-REL-001, NFR-REL-003 | UT-FS-02, UT-FS-03, ST-06, ST-07, ST-08, ST-10 |
...
| UC-FS-003 | Handle File Conflicts | FR-FS-006, FR-OFF-004, NFR-REL-003, NFR-USE-001 | UT-FS-05-01, UT-FS-05-02, IT-05 |
...
|--------------|----------------|----------------------|-------------------------------|------------------------|
| UT-FS-01 | Directory Tree Synchronization | FR-FS-001, FR-FS-005, NFR-PERF-001, NFR-PERF-003 | SAS 3.1.2, SAS 3.1.3, SAS 3.2.1, SAS 5.1 | SDS 2.1, SDS 2.2, SDS 6.1 |
| UT-FS-02 | File Upload Synchronization | FR-FS-002, NFR-PERF-002 | SAS 3.2.1, SAS 3.2.3, SAS 3.4.3 | SDS 2.1, SDS 3.1, SDS 4.2 |
| UT-FS-05-01, UT-FS-05-02 | Repeated File Upload | FR-FS-006, NFR-PERF-002, NFR-REL-003 | SAS 4.3, SAS 5.3 | SDS 2.1, SDS 5.2.1, SDS 5.4 |
| UT-FS-06 | Large File Upload | NFR-PERF-002, NFR-PERF-004 | SAS 3.2.3, SAS 3.4.1, SAS 4.2.2 | SDS 3.1, SDS 4.2.2, SDS 6.2 |
| UT-FS-03 | File Download Synchronization | FR-FS-002, FR-FS-004, NFR-PERF-001, NFR-PERF-002, NFR-PERF-003 | SAS 1.3, SAS 3.2.1, SAS 3.4.3, SAS 4.2.2, SAS 5.1 | SDS 2.1, SDS 3.1, SDS 5.2.1 |
