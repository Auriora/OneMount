...
For detailed documentation, see the code comments in `internal/testutil/framework/network_simulator.go`.
...
For detailed documentation, see the code comments in `internal/testutil/mock/mock_graph.go`, `internal/testutil/mock/mock_filesystem.go`, and `internal/testutil/mock/mock_ui.go`.
