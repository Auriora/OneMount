...
- Generalized Requirements 5, 17, and 20 to describe a pluggable change-notification layer (webhook + optional Engine.IO transport) plus fallbacks, and removed the duplicated Requirement 9 block for consistency.
