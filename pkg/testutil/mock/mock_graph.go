...
func (m *MockGraphProvider) GetItemChildrenPath(path string) ([]*graph.DriveItem, error) {
...
func (m *MockGraphProvider) GetItemPath(path string) (*graph.DriveItem, error) {
...
func (m *MockGraphProvider) Patch(resource string, content io.Reader, headers ...graph.Header) ([]byte, error) {
...
func (m *MockGraphProvider) Post(resource string, content io.Reader, headers ...graph.Header) ([]byte, error) {
...
func (m *MockGraphProvider) Put(resource string, content io.Reader, headers ...graph.Header) ([]byte, error) {
...
func (m *MockGraphProvider) Delete(resource string, headers ...graph.Header) error {
...
func (m *MockGraphProvider) Mkdir(name string, parentID string) (*graph.DriveItem, error) {
