	...
	testCases := []struct {
		...
		},
		{
			...
			verifyFunc: func(t *testing.T, cache *Filesystem, path string) {
				...
				require.Contains(t, children, "OneMount-Documents", "Could not find documents folder")
		...
		},
		{
			...
			verifyFunc: func(t *testing.T, cache *Filesystem, path string) {
				...
				assert.Equal(t, "OneMount-Documents", documents.Name(), "Failed to fetch \"/Documents\"")
			},
		},
		{
			...
			verifyFunc: func(t *testing.T, cache *Filesystem, path string) {
				...
				require.NotContains(t, children, "OneMount-Documents",
